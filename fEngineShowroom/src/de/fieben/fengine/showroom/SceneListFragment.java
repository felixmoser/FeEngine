...
public class SceneListFragment extends ListFragment {
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<SceneProvider.SceneItem>(getActivity(),
				android.R.layout.simple_list_item_activated_1,
				android.R.id.text1, SceneProvider.SCENE_ITEMS));
	}
	...
	public void onListItemClick(final ListView listView, final View view,
		...
		mCallbacks.onItemSelected(SceneProvider.SCENE_ITEMS.get(position).mId);
	}

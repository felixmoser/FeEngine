...
public class FeBitmapPool {
	...
	private static SparseArray<Bitmap> mBitmapPool = new SparseArray<>();

	/**
	 * Stores {@link Bitmap} into the {@link FeBitmapPool} and returns a key.
	 * Use the key to deliver {@link Bitmap}s to {@link FeSurfaceElement}s and {@link FeSurfaceTile}s.
	 *
	...
	/**
	 * @param key The {@link Bitmap}s key returned from {@link #addBitmap(Bitmap)}.
	 ...
	 *
	 * @param key The key of the {@link Bitmap} stored.
	 */
	...
	/**
	 * Resets the {@link FeBitmapPool}. This deletes all previous stored {@link Bitmap}s and key mappings.
	 */
	public static void resetBitmapPool() {
		mBitmapPool = new SparseArray<>();
	}
}
